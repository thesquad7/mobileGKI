...
class FJadwalFormField extends StatefulWidget {
  FJadwalFormField({
    super.key,
    required this.nama,
  ...
  final TextEditingController nama, deskripsi, status;
  @override
  State<FJadwalFormField> createState() => _FJadwalFormField();
}

class _FJadwalFormField extends State<FJadwalFormField> {
  @override
