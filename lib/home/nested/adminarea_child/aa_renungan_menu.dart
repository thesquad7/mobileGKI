...
import 'package:MobileGKI/home/nested/adminarea_child/renungan_menu/list_aamr_renungan.dart';
...
class RenunganMenu extends StatelessWidget {
  RenunganMenu({super.key});
            ...
            child: Padding(
                ...
                child: GridView.count(
                  ...
                  children: <Widget>[
                    SubMenuButton(
                      onPressed: () {
                        GetStorage().write("CategoryPlace", "3");
                        Get.to(() => AcaraCategory());
                      },
                      icon: FRenunganmenu.menuIcon[0],
                      b_title: FRenunganmenu.menuname[0],
                    ),
                    SubMenuButton(
                      onPressed: () => Get.to(() => RenunganAdmin()),
                      icon: FRenunganmenu.menuIcon[1],
                      b_title: FRenunganmenu.menuname[1],
                    ),
                  ],
                )),
          )
