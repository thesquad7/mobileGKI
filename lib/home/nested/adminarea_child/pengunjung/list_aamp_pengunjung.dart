...
import 'package:MobileGKI/data/crud_state/pengunjung/pengunjungView.dart';
...
class PengunjungungAdmin extends StatefulWidget {
  PengunjungungAdmin({
    Key? key,
  }) : super(key: key);

  @override
  State<PengunjungungAdmin> createState() => _PengunjungungAdminState();
}

class _PengunjungungAdminState extends State<PengunjungungAdmin> {
  final PengunjungController RController = Get.put(PengunjungController());
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.small(
          ...
          onPressed: () {
            ...
            GetStorage().write("pagetitle", "Tambah Pengunjung");
            Get.to(() => EditPengunjung(
                  isNImg: false,
                ));
          }),
      body: Obx(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              ...
                              await APIGetPengunjungInfo(
                                      pendetaId: RController
                                          .pengunjung[index].id
                                          .toString())
                                  .getPendeta();
                            },
                            child: HorizontalCard(
                                ...
                                tema:
                                    RController.pengunjung[index].jadwal_name!,
                                nama_pendeta:
